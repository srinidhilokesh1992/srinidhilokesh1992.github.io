      ...
      <main id="home" className="mx-auto max-w-6xl px-4 pb-20 pt-10 sm:px-6 md:pt-14">
        ...
        <Reveal id="teaching" className="pb-20">
          <div className="mb-10 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end">
            ...
            <a
              href="/teaching"
              className={`inline-flex items-center justify-center rounded-full px-6 py-3 text-[11px] font-medium uppercase tracking-[0.24em] transition duration-300 whitespace-nowrap hover:-translate-y-1.5 ${isDark ? "bg-[#dfeaf0] text-[#11161d] hover:bg-white" : "bg-[#171411] text-[#f6f1ea] hover:bg-[#2a2420]"}`}
            >
              View Teaching
            </a>
          </div>
          ...
          <div className={`rounded-[2rem] p-8 shadow-[0_32px_80px_rgba(0,0,0,0.22)] ring-1 backdrop-blur-md ${isDark ? "bg-[linear-gradient(135deg,rgba(15,18,22,0.96),rgba(28,35,42,0.94))] text-[#f6f1ea] ring-white/10" : "bg-[linear-gradient(135deg,rgba(238,243,247,0.96),rgba(255,255,255,0.95))] text-[#171411] ring-[#171411]/10"}`}>
            <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
              ...
              <div className="flex flex-wrap gap-3">
                <a href="mailto:slokesh@unr.edu" className={`rounded-full px-5 py-2.5 text-[11px] font-medium uppercase tracking-[0.22em] transition duration-300 hover:-translate-y-1.5 ${isDark ? "bg-[#f6f1ea] text-[#171411] hover:bg-white" : "bg-[#171411] text-[#f6f1ea] hover:bg-[#2a2420]"}`}>
                  Email me
                </a>
